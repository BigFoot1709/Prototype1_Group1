...
public class MainText : MonoBehaviour
{
    ...
    private void Start()
    {
        if (fontForThisLine == null)
        {
            fontForThisLine = GameObject.Find("MainText").GetComponent<Text>().font;
        }
    ...
    {
        Text currText = GameObject.Find("MainText").GetComponent<Text>();
        if (fontForThisLine != null)
        {
            currText.font = fontForThisLine;
        }

        if (bold && italic)
        {
            currText.fontStyle = FontStyle.BoldAndItalic;
        }
        else if (bold)
        {
            currText.fontStyle = FontStyle.Bold;
        } else if (italic)
        {
            currText.fontStyle = FontStyle.Italic;
        } else
        {
            currText.fontStyle = FontStyle.Normal;
        }
